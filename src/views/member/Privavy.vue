<template>
  <div class="privavy">
    <h2 style="margin-top:50px; margin-bottom : 50px;">회원 가입 약관</h2>
    <b-form-textarea
    ...
    2. 수집하는 개인정보 항목회사는 회원가입, 상담, 서비스 신청 등을 위해 아래와 같은 개인정보를 수집하고 있습니다.
    - 수집항목 : 이름, 로그인ID, 비밀번호, 전화번호, 주소, 휴대전화번호, 이메일, 회사명, 부서, 회사전화번호, 주민등록번호, 은행계좌 정보, 서비스 이용기록, 접속 로그, 접속 IP정보, 결제기록, 회사주소, 사업자등록번호, 회사전화번호
    ...
    5. ExemptionThe company will never release any private information to the public except the following condition.
